      ...
      <div class="container">
        <div class="row text-center">
		   <div class="text-center mx-auto col-10">
			<h2> Listado de la Vista Productos por Categoria</h2>	
		   </div>		
		</div>	
		<div class="row text-center">	
			<div class="text-center mx-auto col-10">
				<center>
			<h2> Listado de la vista de productos por categoria </h2>			
            <?php
            
            // Seleccionamos la tabla con la que vamos a trabajar
            $tabla="productos_por_categoria";// Escribir entre comillas el nombre de la tabla a listar
