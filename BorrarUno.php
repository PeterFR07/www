    ...
    <?php
        ...
        while ($registro = mysqli_fetch_row($resultado)){
            ...
            echo "<table class='table table-sm text-info'> ";
                echo "<tr><td class='text-right text-warning'>IDCLIENTE: </td><td><h5>",$registro[0],"</h5></td></tr>";
                echo "<tr><td class='text-right text-warning'>NOMBRE: </td><td><h5>",$registro[1],"</h5></td></tr>";
                echo "<tr><td class='text-right text-warning'>USUARIO: </td><td><h5>",$registro[2],"</h5></td></tr>";
                echo "<tr><td class='text-right text-warning'>CONTRASEÑA: </td><td><h5>",$registro[3],"</h5></td></tr>";
                echo "<tr><td class='text-right text-warning'>DIRECCION:  </td><td><h5>",$registro[4],"</h5></td></tr>";
                echo "<tr><td class='text-right text-warning'>CORREO:  </td><td><h5>",$registro[5],"</h5></td></tr>";
                echo "<tr><td class='text-right text-warning'>TELEFONO:  </td><td><h5>",$registro[6],"</h5></td></tr>";
		    echo "</table>";
            echo '</div>';					
        }
        ...
        <div class="row py-1 bg-dark text-info">
            ...
            <div class="col-3 text-center">
                <form action="BorraUsuario.php" method="post">
                    ...
                    <input type="image" SRC="estilos/confirmar.jpg" name="Confirmar" height="30" ALT="Eliminar">
                    </p> 
                </form>
            </div>
            <div class="col-3 text-center"> 
                <form action="clientesgestion.php" method="post">
                    ...
                    <input type="image" SRC="estilos/cancelar.png" name="codigo" height="30" ALT="cancelar">
                    </p> 
                </form>
            </div> 
