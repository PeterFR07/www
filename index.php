...
--> 	<div class="py-5 bg-info" style="background-image: url(imagenes/Entrada.jpg);	background-position: top left;	background-size: 100%;	background-repeat: repeat;  height: 1000px;">
      ...
      <div class="row">
        <div class="bg-none text-info col-12 col-sm-12 col-md-7 col-lg-7">			
			<div class="bg-dark-opaque text-warning" style="	background-image: linear-gradient(to bottom, rgba(0, 0, 0, 0.2), rgba(0, 0, 0, 0.9));	background-position: top left;	background-size: 100%;	background-repeat: repeat;">
				<h3 class="display-4">Informatik's</h3>
				<h4>Tu tienda virtual de informática para empresas, negocios y particulares.</h4>
			</div>
        </div>
